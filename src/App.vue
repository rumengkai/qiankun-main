<template>
  <div id="qiankun-main">
    <div class="nav">
      ...
      <router-link tag="li" :to="menu.path" class="menu-item" v-for="menu in menus" :key="menu.key">
        {{ menu.title }}
      </router-link>
    </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        menus: [
          ...
          {
            key: "childtestReact",
            title: "React 子应用home页",
            path: "/child-react/home"
          },
          {
            key: "childtestReactAbout",
            title: "React 子应用About页",
            path: "/child-react/about"
          },
          {
            key: "holmes-platform",
            title: "模型管理",
            path: "/cdp-react/holmes/platform"
          },
          {
            key: "feature-management",
            title: "特征管理",
            path: "/cdp-react/holmes/feature-management"
          }
        ]
      }
    },
    ...
    methods: {
      ...
      push(subapp) {
        ...
        // history.pushState(null, null, "/#/child-react/about")
        history.pushState(null, null, "/#" + subapp)
      }
    }
  }
</script>
